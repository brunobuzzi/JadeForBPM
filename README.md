...
Jade for BPM is a customization of the Jade Environment for BPM Flow (https://github.com/brunobuzzi/BpmFlow).
...
1. Install a Github client such as Git Bash or [SourceTree](http://www.sourcetreeapp.com/).
